...
#include "../435Project/g2_results.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_g2_results_t, stringdata) + ofs \
...
const QMetaObject g2_results::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_g2_results.data,
      qt_meta_data_g2_results,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_g2_results.stringdata))
