...
#include "../435Project/registermenu.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RegisterMenu_t, stringdata) + ofs \
...
QT_MOC_LITERAL(13, 133, 10)
    ...
    "birth_date\0birth_month\0birth_year\0"
};
...
const QMetaObject RegisterMenu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RegisterMenu.data,
      qt_meta_data_RegisterMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RegisterMenu.stringdata))
