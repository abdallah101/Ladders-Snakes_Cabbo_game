...
#include "../435Project/mainmenu_widget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MainMenu_Widget_t, stringdata) + ofs \
...
const QMetaObject MainMenu_Widget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MainMenu_Widget.data,
      qt_meta_data_MainMenu_Widget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainMenu_Widget.stringdata))
