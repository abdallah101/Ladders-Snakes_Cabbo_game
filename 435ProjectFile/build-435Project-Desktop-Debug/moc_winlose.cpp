...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_winlose_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 25, 1)
    },
    "winlose\0exit\0\0setlabel\0a\0b\0"
};
...
const QMetaObject winlose::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_winlose.data,
      qt_meta_data_winlose,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_winlose.stringdata))
