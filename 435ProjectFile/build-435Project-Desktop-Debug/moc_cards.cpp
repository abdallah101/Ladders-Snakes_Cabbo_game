...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Cards_t, stringdata) + ofs \
...
const QMetaObject Cards::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Cards.data,
      qt_meta_data_Cards,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cards.stringdata))
        return static_cast<void*>(const_cast< Cards*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Cards*>(this));
