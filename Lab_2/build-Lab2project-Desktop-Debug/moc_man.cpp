...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_man_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 30, 5)
    ...
    "man\0keyPressEvent\0\0QKeyEvent*\0event\0"
};
...
const QMetaObject man::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_man.data,
      qt_meta_data_man,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_man.stringdata))
        return static_cast<void*>(const_cast< man*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< man*>(this));
